...
import { register as registerUser } from '../services/api'; // Mock API, rename to avoid keyword conflict
...
export default function Register() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-bg-light-gray to-primary-blue-light">
            <Navbar />
            <div className="container mx-auto py-20 flex justify-center">
                ...
                >
                    ...
                    <div className="w-1/2 p-12">
                        <h2 className="text-3xl font-bold text-text-dark-gray mb-8">Registration</h2>
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                            ...
                            <motion.div variants={inputVariants} whileFocus="focus" className="relative">
                                <input
                                    ...
                                    className="w-full p-4 border border-text-sub-gray rounded-xl focus:ring-2 focus:ring-primary-blue-mid"
                                />
                                <FaEnvelope className="absolute right-4 top-1/2 -translate-y-1/2 text-text-sub-gray" />
                        ...
                        <p className="text-center text-text-sub-gray my-6">or register with social platforms</p>
                    ...
                    <div className="w-1/2 bg-gradient-to-br from-primary-blue-dark to-primary-blue-mid p-12 text-bg-white flex flex-col justify-center">
                        <motion.h1
